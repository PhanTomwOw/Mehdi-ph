...
export const ChatBubbleLeftRightIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537a59.453 59.453 0 01-3.58 0l-3.722-.537C6.347 17.1 5.5 16.136 5.5 15v-4.286c0-.97.616-1.813 1.5-2.097m6.5 0a2.25 2.25 0 00-2.25 2.25v4.286c0 1.242 1.008 2.25 2.25 2.25h.008a2.25 2.25 0 002.25-2.25v-4.286c0-1.242-1.008-2.25-2.25-2.25h-.008zM7 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537a59.453 59.453 0 01-3.58 0l-3.722-.537C.347 17.1 0 16.136 0 15V10.714c0-.97.616-1.813 1.5-2.097" transform="translate(2, 2)"/>
    </svg>
);
